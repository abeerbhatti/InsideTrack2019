...
//WebUI.setText(findTestObject('ResourcePage/Common/resourceTitle'), 'Resource IT3-250719')
...
//WebUI.setText(findTestObject('ResourcePage/Common/resourceSummary'), 'Resource IT3-250719 Summary')
...
//WebUI.click(findTestObject('ResourcePage/file/uploadBtn'))
WebUI.scrollToElement(findTestObject('ResourcePage/file/uploadBtn'), 3)
WebUI.delay(2)
WebUI.uploadFile(findTestObject('commonObjects/fileUploadBtnCSS'), '/Users/abeerbhatti/Downloads/TestImage.jpg')
WebUI.delay(4)
