...
for (GlobalVariable.i=1; GlobalVariable.i<=TotalRows; GlobalVariable.i++){
	...
	String resourceTitle = findTestData('Resource').getValue('Resource', GlobalVariable.i)
	String resourceSummary = findTestData('Resource').getValue('ResourceDescription', GlobalVariable.i)
