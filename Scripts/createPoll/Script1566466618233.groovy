...
CustomKeywords.'insideTrack.Discussions.redirecttoPoll'()

String pollName = findTestData('Polls').getValue('Poll', 1)
String pollDescription = findTestData('Polls').getValue('pollDescription', 1)
String optionA = findTestData('Polls').getValue('Answer1', 1)
String optionB = findTestData('Polls').getValue('Answer2', 1)
String optionC = findTestData('Polls').getValue('Answer3', 1)
String privateGroup = findTestData('Polls').getValue('privateGroup', 1)
String categoryName = findTestData('Polls').getValue('categoryName', 1)
