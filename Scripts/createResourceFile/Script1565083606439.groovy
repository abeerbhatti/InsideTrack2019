...
String resourceTitle = findTestData('Resource').getValue('resourceTitle', 3)
String resourceSummary = findTestData('Resource').getValue('resourceSummary', 3)
String type = findTestData('Resource').getValue('Type', 3)
String privateGroup = findTestData('Resource').getValue('privateGroup', 3)
String categoryName = findTestData('Resource').getValue('categoryName', 3)
